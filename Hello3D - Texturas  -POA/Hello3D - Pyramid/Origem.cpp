...
bool rotate1 = false, rotate2 = false, rotate3 = false;
...
//#endif
	...
	Shader shader2("Phong.vs", "Phong.fs");
	...
	shader2.setMat4("view", value_ptr(view));
	...
	glm::vec3 sunPos = glm::vec3(3.0, 0.0, 0.0);

	Object obj;
	obj.initialize("C:/Users/carlo/Desktop/computacao-grafica-unisinos-ta-2023-1-main/computacao-grafica-unisinos-ta-2023-1-main/3D_Models/Suzanne/bola.obj", &shader, objPos);

	Object sun;
	sun.initialize("C:/Users/carlo/Desktop/computacao-grafica-unisinos-ta-2023-1-main/computacao-grafica-unisinos-ta-2023-1-main/3D_Models/Suzanne/suzanneTri.obj", &shader2, sunPos);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (rotate1)
		{
			...
			shader2.setMat4("model", glm::value_ptr(model2));
			sun.draw();
